...
import Database from "../components/Svgfolder/Database";
import XGBoost from "../components/Svgfolder/XGBoost";
import Joblib from "../components/Svgfolder/joblib";
import Numpy from "../components/Svgfolder/Numpy";
import Trophy from "../components/Svgfolder/Trophy";
import Cube from "../components/Svgfolder/Cube";
                    ...
                    <div className="herotextsection flex flex-col flex-1 p-8 gap-4 ">
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="gap-4">
                                ...
                                <h1>advanced machine learnig models and real-world data.</h1>
                                <h1>It also allows you to compare different regression models</h1>
                                <h1>and udnerstand the fators that influence car prices.</h1>
                    ...
                    <div className="right-grid flex flex-col flex-2 bg-[#161622] min-h-400px p-4  rounded-xl border border-[#2A2D4F]">
                        ...
                        <div
                            ...
                            <div className="frontend flex flex-col   ">
                                ...
                                <div className="frontendstack flex justify-between ">

                                    <div className="nextjs flex flex-col gap-2">

                                        <svg className="w-15 h-15" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="0 0 128 128">
                                            <path
                                    ...
                                    <div className="REACT flex flex-col gap-2 ">
                                    ...
                                    <div className="tailwindcss flex flex-col gap-2">
                                        <svg className="w-15 h-15" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="0 0 128 128">
                                            <path
                            ...
                            {/*Frontend div  closed above and backend div opening below*/}
                            <div className="flex flex-col backend-wrapperdiv  flex-1">
                                <h1 className="text-white">Backend</h1>
                                <div className="backend flex justify-center items-center gap-12 p-2">
                                    <div className="python">
                                        <svg className="w-15 h-15" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="0 0 128 128">
                                            <linearGradient id="python-original-a" gradientUnits="userSpaceOnUse"
                                                            x1="70.252" y1="1237.476" x2="170.659" y2="1151.089"
                                                            gradientTransform="matrix(.563 0 0 -.568 -29.215 707.817)">
                                                <stop offset="0" stop-color="#5A9FD4"/>
                                                <stop offset="1" stop-color="#306998"/>
                                            </linearGradient>
                                            <linearGradient id="python-original-b" gradientUnits="userSpaceOnUse"
                            ...
                            {/*Backend div closed above and ml div below*/}
                            <div className="mlwrapper flex flex-col  flex-2">
                                <h1 className="self-center text-white">Machine Learning</h1>
                                <div className="mlcontainer flex justify-between">
                                    <div className="machinelearningcardscontainer flex flex-col gap-2 ">
                                        <svg className="w-15 h-15" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="0 0 128 128">
                                            <path fill="#f89939"
                                    ...
                                    <div className="machinelearningcardscontainer flex flex-col gap-2 ">
                                        ...
                                        <XGBoost className="w-15 h-15"/>
                                        <h1 className="text-white">XGBoost</h1>
                                    </div>

                                    <div className="machinelearningcardscontainer flex flex-col gap-2 ">
                                        <Numpy className="w-15 h-15"/>
                                    ...
                                    <div className="machinelearningcardscontainer flex flex-col gap-2 ">
                                        <Joblib className="w-15 h-15"/>

                                        <h1 className="text-white">Joblib</h1>
                                    </div>
...
lg:divide-y-0
lg:divide-x">
                            <div className="flex gap-5   items-center flex-1 p-4 ">
                                <div
                                    className="bg-[#0F1220] h-fit rounded-full shadow-lg border p-2 border-[#5A42C8] shrink-0">
                                ...
                                <div>
                                    ...
                                    <p className="text-white text-xl">Car Records</p>
                                    <p className="text-white text-xl">High Quality Dataset</p>
                                </div>
                            ...
                            <div className="flex gap-5   items-center flex-1 p-4 ">
                                <div
                                    className="bg-[#0F1220] h-fit rounded-full shadow-lg border p-2 border-[#5A42C8] shrink-0">
                                    <Cube className=" w-10 h-10 text-[#3C0366]"/>
                                </div>
                                <div>

                                    <p className="text-white text-2xl">5</p>
                                    <p className="text-white text-xl">Ml Models</p>
                                    <p className="text-white text-xl">Trained and Evaluated</p>
                                </div>
                            ...
                            <div className="flex gap-5   items-center flex-1 p-4 ">
                                <div
                                    className="bg-[#0F1220] h-fit rounded-full shadow-lg border p-2 border-[#5A42C8] shrink-0">
                                    <TargetIcon className=" w-10 h-10 text-[#3C0366]"/>
                                </div>
                                <div>
                            ...
                            <div className="flex gap-5   items-center flex-1 p-4 ">
                                <div
                                    className="bg-[#0F1220] h-fit rounded-full shadow-lg border p-2 border-[#5A42C8] shrink-0">
                                    <TrendingUp className=" w-10 h-10 text-[#3C0366]"/>
                                </div>
                                <div>
                            ...
                            <div className="flex gap-5   items-center flex-1 p-4 ">
                                <div
                                    className="bg-[#0F1220] h-fit rounded-full shadow-lg border p-2 border-[#5A42C8] shrink-0">
                                    <Lightning className=" w-10 h-10 text-[#3C0366]"/>
                                </div>
                                <div className="flex flex-col gap-2">
                    ...
                    <div className="wrapperdiv bg-[#161622] flex flex-col lg:flex-row border   border-[#5A42C8] p-4 justify-center items-center gap-4 rounded-xl">
                        <div className="left flex gap-8 flex-2">
                            ...
                            <div className="textdiv flex flex-col gap-2 text-white">
                                ...
                                <p>Data Science STudent & Full Stack Developer</p>
                                <p>Build CarSense to explore machine learning ,full-stack development,</p>
                                <p>and modern ui design.</p>
                            </div>
                        </div>
                        <div className="right-buttonsdiv flex flex-1 gap-4 text-white ">
                            <button className="bg-[#161622] border border-[#5A42C8] p-2 rounded-xl shrink-0">Github</button>
                            <button className="bg-[#161622] border border-[#5A42C8] p-2 rounded-xl">Linkedin</button>
                            <button className="bg-[#161622] border border-[#5A42C8] p-2 rounded-xl">Email</button>
                        </div>
                    </div>
                </section>
            </main>
